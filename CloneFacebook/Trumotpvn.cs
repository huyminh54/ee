...
namespace CloneFacebook
{
	public class Trumotpvn
	{
		public string Getphone(string api)
		{
			...
			try
			{
				RestClient restClient = new RestClient("https://trumotpvn.com/api/v1/order");
		...
		public string Getcode(string api, string id)
		{
			...
			try
			{
				RestClient restClient = new RestClient("https://trumotpvn.com/api/v1/order/" + id);
				restClient.Timeout = -1;
